...
if(dist_calc<6){             //this goes after the serial print of the distance in the function "distance". refer to my code. 4=radius
...
servo.write(77);  // turn wheels left
esc.write(85);  //our speed
